...
void tampilkanMenuAdmin() {
    ...
    cout << "6. Sorting Data Pemain   [NEW]" << endl;
    cout << "7. Logout"                      << endl;
}
        ...
        if (pilihanLayarAwal == 1) {
            ...
            while (tetapDiMenu) {
                ...
                if (sesiLogin.peran == "admin") {
                    ...
                    else if (pilihanMenu == 6) menuSortingAdmin(daftarPemain, jumlahDataPemain); // SORTING
                    else if (pilihanMenu == 7) tetapDiMenu = false;
                } else {
